...
experimental ABI backend already carries named byte streams over it, and
development `yumed-ytp1`/`yume-ytp1` processes run direct routes and SOCKS5
CONNECT. Packet operations remain unsupported.
