...
`yume-setup` prints for a key. `yume_module_files` adds relay file transfer:
...
replacing anything, only after the declared size and SHA-256 match. No module
uses these libraries yet.
