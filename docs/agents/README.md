...
| --- | --- |
| Transport, AUTH, ratchet | [YTP/1](../protocol/YTP_1.md) and its construction vectors for the native protocol; [transport-v2 wire](../protocol/YUME_2_0_WIRE.md) and [security modes](../SECURITY_MODES.md) for the reference graph; focused protocol/security tests |
