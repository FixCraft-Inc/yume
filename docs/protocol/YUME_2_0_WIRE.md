...
4096 nonces for two hours measured by a monotonic clock, independently of the
authenticated wall-clock bucket. When full, it refuses new admissions until entries
