...
void print_help() {
    std::cout
        ...
        << "  --fullbench              Run the local scored device benchmark via\n"
        << "                             yume-selftest; no server or auth key required.\n"
