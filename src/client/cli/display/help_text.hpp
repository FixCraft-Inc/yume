// Generated by scripts/yume_cli.py from docs/src/en_US/cli/yume-v2-reference.cli. Do not edit.
//
// YUME - Yume Universal Multiprotocol Engine
// Copyright (C) 2020-2026  FixCraft Inc.
// Licensed under the GNU Affero General Public License v3.0 or later.
//
// The option model lives in the yume_v2_reference_1 manual source. Edit the
...
namespace yume::client::cli {

inline void write_help_body(std::ostream& out) {
    out
        << "Usage:\n"
        << "  yume-v2-reference --server <host> -i <id_ed25519> [mode] [options]\n"
        << "  yume-v2-reference completion bash\n"
        << "  yume-v2-reference --help\n"
        << "  yume-v2-reference --version\n"
        << "  yume-v2-reference --credits\n"
        << "  Transport-v2 reference build; use its transport-v2 configuration.\n"
        << "\n"
        << "Connection:\n"
        ...
        << "                             against yumed-v2-reference --bench, then exit.\n"
        ...
        << "  --attach-local           Attach to a local yume-v2-reference\n"
        ...
        << "                           Reach the YUME server through a SOCKS5 proxy\n"
        ...
        << "                             `yume-v2-reference --config <path>` to use them.\n"
...
complete -F _yume-v2-reference_complete yume-v2-reference
)";
}
