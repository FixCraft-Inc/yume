// Generated by scripts/yume_cli.py from docs/src/en_US/cli/yume.cli. Do not edit.
//
// YUME - Yume Universal Multiprotocol Engine
// Copyright (C) 2020-2026  FixCraft Inc.
// Licensed under the GNU Affero General Public License v3.0 or later.
//
// The option model lives in the yume_1 manual source. Edit the
...
inline void write_bash_completion(std::ostream& out) {
    out << R"(# bash completion for yume
_yume_complete() {
  local cur prev
