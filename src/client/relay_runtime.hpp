...
public:
    ...
    bool open_chat(const std::string& peer, const std::string& password, std::string* error);
    bool send_chat(const std::string& text, std::string* error);
    bool send_file(const std::string& peer, const std::filesystem::path& path, const std::string& password, std::string* error);
    bool send_bytes_path(const std::string& peer, const std::filesystem::path& path, const std::string& password, std::string* error);
    bool accept_invite(const std::string& invite_id, const std::string& password, std::string* error);
...
private:
    ...
    void handle_channel_close(uint8_t stream_id);
