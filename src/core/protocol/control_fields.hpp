...
inline constexpr char ephemeral_pubkey_b64[] = "ephemeral_pubkey_b64";
inline constexpr char ephemeral_signature_b64[] = "ephemeral_signature_b64";
...
inline constexpr char nonce_b64[] = "nonce_b64";
...
inline constexpr char response_ephemeral_pubkey_b64[] = "response_ephemeral_pubkey_b64";
inline constexpr char response_ephemeral_signature_b64[] = "response_ephemeral_signature_b64";
