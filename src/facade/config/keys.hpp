...
inline constexpr char accept_rate_limit[] = "accept_rate_limit";
...
inline constexpr char admin_identity[] = "admin_identity";
...
inline constexpr char anonym_token_file[] = "anonym_token_file";
...
inline constexpr char app_codec[] = "app_codec";
inline constexpr char app_codec_listen[] = "app_codec_listen";
inline constexpr char app_codec_listen_host[] = "app_codec_listen_host";
inline constexpr char app_codec_listen_port[] = "app_codec_listen_port";
inline constexpr char auto_attach_local[] = "auto_attach_local";
inline constexpr char benchmark_enable[] = "benchmark_enable";
...
inline constexpr char bulk_key_max_sessions[] = "bulk_key_max_sessions";
inline constexpr char max_sessions[] = "max_sessions";
inline constexpr char federation_operator_ca[] = "federation_operator_ca";
inline constexpr char federation_identity[] = "federation_identity";
inline constexpr char federation_enable[] = "federation_enable";
inline constexpr char cluster_bootstrap[] = "cluster_bootstrap";
...
inline constexpr char host_mode[] = "host_mode";
inline constexpr char accept_yume_clients[] = "accept_yume_clients";
inline constexpr char client_deny_action[] = "client_deny_action";
inline constexpr char exposure_check_hostname[] = "exposure_check_hostname";
inline constexpr char routes[] = "routes";
inline constexpr char listeners[] = "listeners";
...
inline constexpr char obfs_jitter_ms[] = "obfs_jitter_ms";
inline constexpr char obfs_pad_multiple[] = "obfs_pad_multiple";
inline constexpr char obfs_secret_file[] = "obfs_secret_file";
inline constexpr char inner_psk_file[] = "inner_psk_file";
...
inline constexpr char real_backend[] = "real_backend";
...
inline constexpr char relay_receive_dir[] = "relay_receive_dir";
inline constexpr char relay_mode[] = "relay_mode";
inline constexpr char relay_peer_pins[] = "relay_peer_pins";
inline constexpr char relay_trust_dir[] = "relay_trust_dir";
inline constexpr char relay_trust_mode[] = "relay_trust_mode";
...
inline constexpr char server_in_charge[] = "server_in_charge";
inline constexpr char server_in_charge_port[] = "server_in_charge_port";
...
inline constexpr char socks_bind[] = "socks_bind";
inline constexpr char socks_port[] = "socks_port";
inline constexpr char threads[] = "threads";
inline constexpr char non_interactive[] = "non_interactive";
...
inline constexpr char tls_pin[] = "tls_pin";
...
inline constexpr char udp[] = "udp";
inline constexpr char upstream_response_dir[] = "upstream_response_dir";
inline constexpr char upstream_response_ttl[] = "upstream_response_ttl";
