...
// "yume-backup.yume-share"); pass empty to leave it blank. On
// systems that don't ship a native picker (no zenity / kdialog /
// yad on PATH), returns nullopt and sets *err.
