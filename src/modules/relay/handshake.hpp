...
// The relay v2 end-to-end handshake between two YUME users whose channel a
// server relays. Each side signs with its composite identity, and the hybrid
// ML-KEM-1024 + X25519 exchange, with an optional out-of-band PSK, yields the
// initial root and epoch PSK of the channel's SessionRatchet. Every domain,
// field id and wire value is the relay v2 definition and must not change.
