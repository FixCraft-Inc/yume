...
void print_help() {
    std::cout << yume::release::render_brand_header(
        ...
        << "  --allow-exec             Enable server command execution only in a\n"
        << "                             YUME_FEATURE_EXEC build; otherwise warned and ignored\n"
