// Generated by scripts/yume_cli.py from docs/src/en_US/cli/yumed-v2-reference.cli. Do not edit.
//
// YUME - Yume Universal Multiprotocol Engine
// Copyright (C) 2020-2026  FixCraft Inc.
// Licensed under the GNU Affero General Public License v3.0 or later.
//
// The option model lives in the yumed_v2_reference_8 manual source. Edit the
...
inline void write_help_body(std::ostream& out) {
    out
        << "Usage:\n"
        << "  yumed-v2-reference [--config <path>] [options]\n"
        << "  yumed-v2-reference completion bash\n"
        << "  yumed-v2-reference --completion bash\n"
        << "  yumed-v2-reference --help\n"
        << "  yumed-v2-reference --version\n"
        << "  yumed-v2-reference --credits\n"
        ...
        << "  --config <path>          JSON config; relative file paths use its directory\n"
        ...
        << "  --filter-geolite <path>  Country DB or archive (archives: Linux only).\n"
        ...
        << "                             benchmark streams for yume-v2-reference --bench.\n"
        ...
        << "  --public-node            Hardening preset for an internet-facing reference daemon.\n"
        ...
        << "  --attach-local           Attach to a local yumed-v2-reference\n"
        << "\n"
        << "Key Management:\n"
...
complete -F _yumed-v2-reference_complete yumed-v2-reference
)";
}
